...
### صيغة الإخراج (JSON فقط):
{{
    "ministry": "اسم الجهة المعلنة بالكامل (وزارة، شركة، هيئة، مؤسسة، أي جهة)" أو null,
...
- للجهة المعلنة: استخرج الاسم الكامل بالضبط (أمثلة: "وزارة الصحة"، "شركة نفط الكويت"، "الهيئة العامة للإسكان")
